...
public class ScheduleConductorWorkflowExecutionJob extends QuartzJobBean {
    ...
    private String runLog = AppConstants.DEFAULT_STRING_INITIALIZOR;
    ...
    protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
        ...
        this.runLog = AppConstants.DEFAULT_STRING_INITIALIZOR;
        ...
        String json = jobDataMap.getString(AppConstants.JSON);
