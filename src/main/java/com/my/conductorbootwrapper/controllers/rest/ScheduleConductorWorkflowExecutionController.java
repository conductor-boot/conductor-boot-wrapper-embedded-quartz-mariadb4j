...
public class ScheduleConductorWorkflowExecutionController {
    ...
    public ResponseEntity<ScheduleConductorWorkflowExecutionResponse> schedule(@Valid @RequestBody ScheduleConductorWorkflowExecutionRequest request) {
    	...
    	try {
    		...
    		conductorQuartzMapping.setScheduleCurrentStatus(AppConstants.DRAFT);
            ...
            conductorQuartzMapping.setScheduleCurrentStatus(AppConstants.SCHEDULED);
            conductorQuartzMapping = this.conductorQuartzMappingRepository.saveAndFlush(conductorQuartzMapping);
    		
            return new ResponseEntity(new ScheduleConductorWorkflowExecutionResponse(uniqueIdentifier, AppConstants.SUCCESS), HttpStatus.OK);
    	}
    	catch(Exception e) {
    		e.printStackTrace();
    	}
    ...
    public ResponseEntity<ScheduleConductorWorkflowExecutionResponse> pause(@RequestParam String scheduleId)
    {
    	try {
    		...
    		if(null!=conductorQuartzMapping) {
    			...
    			schedulerFactoryBean.getScheduler().pauseJob(new JobKey(scheduleId, AppConstants.JOB_IDENTIFIER_GROUP));
    			
    			conductorQuartzMapping.setScheduleCurrentStatus(AppConstants.PAUSED);
    			
    			conductorQuartzMapping = this.conductorQuartzMappingRepository.saveAndFlush(conductorQuartzMapping);

    			return new ResponseEntity(new ScheduleConductorWorkflowExecutionResponse(conductorQuartzMapping.getQuartzSchedulerId(), AppConstants.SUCCESS), HttpStatus.OK);
    		}
    		else
    		{
	...
	public ResponseEntity<ScheduleConductorWorkflowExecutionResponse> resume(@RequestParam String scheduleId)
    {
    	try {
    		...
    		if(null!=conductorQuartzMapping) {
    			...
    			schedulerFactoryBean.getScheduler().resumeJob(new JobKey(scheduleId, AppConstants.JOB_IDENTIFIER_GROUP));
	...
	public ResponseEntity<ScheduleConductorWorkflowExecutionResponse> deleteWorkflowExecution(@RequestParam String scheduleId)
    {
    	try {
    		...
    		if(null!=conductorQuartzMapping) {
    			...
    			schedulerFactoryBean.getScheduler().deleteJob(new JobKey(scheduleId, AppConstants.JOB_IDENTIFIER_GROUP));
    			
    			this.conductorQuartzMappingRepository.delete(conductorQuartzMapping);
    			
    			return new ResponseEntity(new ScheduleConductorWorkflowExecutionResponse(scheduleId, AppConstants.SUCCESS), HttpStatus.OK);
    		}
    		else
    		{
    			return new ResponseEntity(HttpStatus.BAD_REQUEST);
